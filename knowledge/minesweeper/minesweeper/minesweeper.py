...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        self.safes.add(cell)
        neighbor_cells=self.return_close_cells(cell)
        new_count =copy(count)
        new_sentence=Sentence(neighbor_cells,new_count)
        # update the new sentence to the current knowledge
        for cell in neighbor_cells:
            if   cell in self.safes :
                new_sentence.mark_safe(cell)
            elif cell in self.mines :
                new_sentence.mark_mine(cell) 
        # added updated sentence to self.knowledge :
        self.knowledge.append(new_sentence)
        #new knwoledge from current knowledge
        for sentence in self.knowledge:
        ...
        # infere new knowledge based on the subset method
